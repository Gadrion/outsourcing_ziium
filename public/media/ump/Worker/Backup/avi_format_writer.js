...
function AviFormatWriter() {
  ...
  Constructor.prototype = {
     ...
     * @param : str is a data for writing
     */
    writeChunkHeader: function (_dummyCount) {
      var dummyCount = _dummyCount;
      if (typeof dummyCount === "undefined" || dummyCount === null) {
        dummyCount = 0;
      }
    ...
    getIndexBuffer: function () {
      ...
      for (var i = this.aviIndexEntry.dummycount; i > 0; i--) {
        ...
        this.writeInt32(this.aviIndexEntry.offset -
                        (SIZE_OF_CHUNK_HEADER * this.aviIndexEntry.dummycount));
        this.writeInt32(0);
      }
      this.writeString(this.aviIndexEntry.chid);
      this.writeInt32(this.aviIndexEntry.flag);
    ...
    getAviSampleSize: function () {
      var size = Math.floor((this.streamFormat.BitsPerSample + 7) / 8) * this.streamFormat.Channels;
      if (size === 0) {
        size = 1;
      }
      return size;
